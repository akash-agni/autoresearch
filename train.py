...
# ---------------------------------------------------------------------------
# Feature Engineering — best config + polynomial interactions on key numerics
# ---------------------------------------------------------------------------
...
def add_features(df):
    ...
    # Additional polynomial-style interactions
...
print(f"model:            Ridge(alpha=10) + outlier + Neighborhood enc + poly interactions")
